...
export function calculateAnthropicCost(
  ...
  if (
    ...
    const inputCost = config.inputCost ?? config.cost ?? (promptTokens > 200_000 ? 6 / 1e6 : 3 / 1e6);
    const outputCost = config.outputCost ?? config.cost ?? (promptTokens > 200_000 ? 22.5 / 1e6 : 15 / 1e6);
